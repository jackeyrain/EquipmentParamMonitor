...
namespace WindowsFormsApp1
{
    public partial class FrmMain : Form
    {
        ...
        string sql = @"SELECT P.* from ( 
                        ...
                        SELECT a.SHIPPING_CODE, a.SEQ, b.CUST_INFO_SEQ, a.STATUS, COUNT(b.CUST_INFO_SEQ) 'COUNT' From MES.TT_WM_SHIPPING a with(nolock) inner join MES.TT_WM_SHIPPING_DETAIL b with(nolock) on a.FID = b.SHIPPING_FID
